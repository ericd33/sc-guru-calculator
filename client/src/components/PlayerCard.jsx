...
export default function PlayerCard({data, sm, onAssignPlayer, chem}) {
  ...
  return (
    <Grid container mx='auto' className="playerCard" direction='column' style={{backgroundImage: `url(${data.cardImg})`, width:sm?'100px':'200px', height:sm?'150px':'300px', border:sm?'3px outset #37ff6d':"none  "}}>
      <Grid item xs={6} md={9} >
